...
(function (ActionAppCore, $) {
    ...
    ThisPage.preInit = function(){
        console.log("preInit in logs page");
    }
    ...
    function refreshMessageCenter() {
        var tmpContentHTML = $.templates['app-logs-message-center-item'].render(ThisApp.getMessages());
        $('[facet="logs-messages"]').html(tmpContentHTML);
    }
